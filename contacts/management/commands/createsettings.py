...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Settings.objects.create(name="Sorta Sensitive", sound_level=1.5, is_active=False)
        self.stdout.write('Created Middle Sensitive Setting')
        Settings.objects.create(name="Not Sensitive", sound_level=2.0, is_active=False)
